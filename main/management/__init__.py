...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            self.stdout.write("\n" + "="*60)
            self.stdout.write("Р В Р’В Р РЋРІвЂћСћР В Р’В Р РЋРІР‚в„ўР В Р’В Р В Р вЂ№Р В Р’В Р РЋРЎвЂєР В Р’В Р РЋРІР‚С”Р В Р’В Р РЋРЎв„ўР В Р’В Р РЋРЎС™Р В Р’В Р вЂ™Р’В«Р В Р’В Р Р†Р вЂљРЎС› Р В Р’В Р РЋРЎСџР В Р’В Р РЋРІР‚С”Р В Р’В Р Р†Р вЂљРЎвЂќР В Р’В Р В РІР‚РЋ Р В Р’В Р Р†Р вЂљРЎвЂќР В Р’В 